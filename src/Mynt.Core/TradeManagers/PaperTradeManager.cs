...
namespace Mynt.Core.TradeManagers
{
    public class PaperTradeManager : ITradeManager
    {
        ...
        public PaperTradeManager(IExchangeApi api, ITradingStrategy strategy, INotificationManager notificationManager, ILogger<PaperTradeManager> logger, TradeOptions settings, IDataStore dataStore)
        {
            _api = api;
            _strategy = strategy;
            _logger = logger;
